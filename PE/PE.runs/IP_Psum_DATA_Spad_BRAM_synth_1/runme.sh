...
HD_PWD='D:/Eyeriss v2 Accelerator/PE/PE.runs/IP_Psum_DATA_Spad_BRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_Psum_DATA_Spad_BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IP_Psum_DATA_Spad_BRAM.tcl
