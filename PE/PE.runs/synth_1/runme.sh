...
HD_PWD='D:/Eyeriss v2 Accelerator/PE/PE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PE_Cluster.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PE_Cluster.tcl
