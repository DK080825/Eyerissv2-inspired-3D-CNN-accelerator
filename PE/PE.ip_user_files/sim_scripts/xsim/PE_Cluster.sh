...
#
# Script generated by Vivado on Wed Mar 25 20:59:05 +0700 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : PE_Cluster.sh
...
#
# Usage        : PE_Cluster.sh
#                PE_Cluster.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PE_Cluster.sh [-reset_run]
#                PE_Cluster.sh [-reset_log]
#                PE_Cluster.sh [-help]
#
...
# script info
echo -e "PE_Cluster.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PE_Cluster.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot PE_Cluster xil_defaultlib.PE_Cluster xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PE_Cluster -key {Behavioral:sim_1:Functional:PE_Cluster} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PE_Cluster.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PE_Cluster.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PE_Cluster.sh [-help]\n\
Usage: PE_Cluster.sh [-step]\n\
Usage: PE_Cluster.sh [-lib_map_path]\n\
Usage: PE_Cluster.sh [-reset_run]\n\
Usage: PE_Cluster.sh [-reset_log]\n\
Usage: PE_Cluster.sh [-keep_index]\n\
Usage: PE_Cluster.sh [-noclean_files]\n\n\
