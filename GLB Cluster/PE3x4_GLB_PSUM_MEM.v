...
// Description : Payload-only GLB memory for PSUM/output payloads.
//               Stores four physical column lanes, each lane carrying two
//               21-bit PSUM values. This module is storage only.
// ============================================================================
...
module PE3x4_GLB_PSUM_MEM #(
    ...
    (* ram_style = "block" *) reg [167:0] mem_r [0:DEPTH-1];

    reg        ctrl_rd_valid_r;
    reg [167:0] ctrl_rd_data_r;
