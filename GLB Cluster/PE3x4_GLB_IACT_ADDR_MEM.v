...
// Description : Payload-only GLB leaf memory for IACT address lanes.
//               Stores three physical lanes, each with two 5-bit address packets.
...
module PE3x4_GLB_IACT_ADDR_MEM #(
    ...
    localparam integer BANK_DW = 10;
    localparam integer TOTAL_DW = 30;
